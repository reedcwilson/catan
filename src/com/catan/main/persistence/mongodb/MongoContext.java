...
import com.catan.main.persistence.file.FileOperationStatement;

import java.util.List;

public class MongoContext<T extends PersistenceModel> extends DataContext<T, FileOperationStatement> {

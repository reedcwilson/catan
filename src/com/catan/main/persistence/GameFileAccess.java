...
public class GameFileAccess extends GameAccess {
    ...
    /**
     * an insert method which adds the given Game to file system
    ...
    /**
     * a delete method which removes the given Game from the file system
    ...
    /**
     * an update method which updates the given Game in the file system
